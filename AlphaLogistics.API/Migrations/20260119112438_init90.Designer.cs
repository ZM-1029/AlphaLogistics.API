...
namespace AlphaLogistics.API.Migrations
{
    ...
    [Migration("20260119112438_init90")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AlphaLogistics.API.Model.PradeshMaster", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("AlphaLogistics.API.Model.UserMaster", b =>
                {
                    ...
                    b.HasOne("AlphaLogistics.API.Model.RoleMaster", null)
            ...
            modelBuilder.Entity("AlphaLogistics.API.Model.VendorMaster", b =>
                {
                    b.HasOne("AlphaLogistics.API.Model.UserMaster", "CreatedByUser")
                        .WithMany()
                        .HasForeignKey("CreatedBy")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("AlphaLogistics.API.Model.UserMaster", "UpdatedByUser")
                        .WithMany()
                        .HasForeignKey("UpdatedBy")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("AlphaLogistics.API.Model.UserMaster", "UserMaster")
                        .WithOne("VendorMaster")
                        .HasForeignKey("AlphaLogistics.API.Model.VendorMaster", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
